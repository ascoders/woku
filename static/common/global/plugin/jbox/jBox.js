...
function jBox(type, options) {
	...
	this.defaultOptions = {
		...
		'Confirm': {
			...
			animation: 'zoomOut',
			preventDefault: true,
			_onAttach: function _onAttach(el) {
		...
		'Image': {
			...
			_onInit: function _onInit() {
				...
				var showLabel = function showLabel(gallery, id) {
	...
	this._adjustPosition = function () {
		...
		if (this.options.adjustPosition != 'move' && (outX == this.outside || outY == this.outside)) {
			...
			if ((this.outside == 'top' || this.outside == 'left' ? windowDimensions[this._getXY(this.outside)] - (this.targetDimensions[this._getTL(this.outside)] - windowDimensions[this._getTL(this.outside)]) - this.targetDimensions[this._getXY(this.outside)] + this.options.offset[this._getXY(this.outside)] : this.targetDimensions[this._getTL(this.outside)] - windowDimensions[this._getTL(this.outside)] - this.options.offset[this._getXY(this.outside)]) > this.dimensions[this._getXY(this.outside)] + parseInt(this.options.adjustDistance[this._getOpp(this.outside)])) {
