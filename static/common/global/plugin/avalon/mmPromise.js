...
define("nativePromise", ["avalon"], function (avalon) {
    ...
    //2015.3.12 支持async属性
    var msPromise = function msPromise(executor) {
        this._callbacks = [];
        var me = this;
    ...
    msPromise.prototype = {
        ...
        _fire: function _fire(onSuccess, onFail) {
        ...
        _then: function _then(onSuccess, onFail) {
            if (this._fired) {
                //在已有Promise上添加回调
                var me = this;
        ...
        then: function then(onSuccess, onFail) {
