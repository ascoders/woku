...
jQuery.fn.extend({ backspace: function backspace(e, t) {
    var n;return (n = jQuery.extend({ callback: function callback() {}, keypress: function keypress() {}, t: 100, e: .04 }, t), this.each(function () {
      var t;return (t = this, jQuery(t).queue(function () {
        var r, u;return (r = t.tagName === "input".toUpperCase() || t.tagName === "textarea".toUpperCase() ? "value" : "innerHTML", (u = function (e) {
  ...
  }, typetype: function typetype(e, t) {
    var n, r;return (r = jQuery.extend({ callback: function callback() {}, keypress: function keypress() {}, t: 100, e: .04 }, t), n = function (t) {
      return Math.random() * r.t * (e[t - 1] === e[t] ? 1.6 : "." === e[t - 1] ? 12 : "!" === e[t - 1] ? 12 : "?" === e[t - 1] ? 12 : "\n" === e[t - 1] ? 12 : "," === e[t - 1] ? 8 : ";" === e[t - 1] ? 8 : ":" === e[t - 1] ? 8 : " " === e[t - 1] ? 3 : 2);
    }, this.each(function () {
      var t;return (t = this, jQuery(t).queue(function () {
        var u, a, c, i;return (a = t.tagName === "input".toUpperCase() || t.tagName === "textarea".toUpperCase() ? "value" : "innerHTML", u = function (e, n) {
