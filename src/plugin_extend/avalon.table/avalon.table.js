...
define(["jquery", "text!pulgin_extend/plugin_extend/avalon.table/avalon.table.html", 'avalon.page', 'jquery.timeago', 'jquery.contextMenu', 'jquery.jbox'], function ($, tableHtml, pageVm) {
